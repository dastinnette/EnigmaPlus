...
class EncryptorTest < Minitest::Test
  ...
  def test_cipher_rotation_works_properly
    skip
  ...
  def test_word_encrypts_properly_based_on_different_4_part_cipher
    input = "1111"
    encryptor = Encryptor.new
  ...
  def test_word_encrypts_properly_based_on_complex_4_part_cipher
    ...
    input = "1111"
    encryptor = Encryptor.new
    assert_equal "2345", encryptor.encrypt(input, 27, 45, 99, 2)
  end
end
