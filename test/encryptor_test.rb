...
class EncryptorTest < Minitest::Test
  ...
  def test_input_string_length_equals_output_string_length
    encryptor = Encryptor.new(1, 1, 1, 1)
    string = "1111"
    assert string.length == encryptor.encrypt(string).length
  end
end
